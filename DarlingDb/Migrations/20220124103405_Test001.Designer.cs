...
{
    [DbContext(typeof(db))]
    [Migration("20220124103405_Test001")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DarlingDb.Models.Users_Data", b =>
                {
                    b.HasBaseType("DarlingDb.Models.Users");

                    b.Property<ulong>("Coins")
                        .HasColumnType("INTEGER");

                    b.HasDiscriminator().HasValue("Users_Data");
                });
            ...
            modelBuilder.Entity("DarlingDb.Models.Users", b =>
                {
                    b.HasOne("DarlingDb.Models.DarlingBoost", "Boost")
                        .WithMany("Users")
